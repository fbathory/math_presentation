...
$$
P(t)=P(0)*e^{r(t-t_0)}
$$ If we derive this function, we get that the differential equation we get $P'(t)=P(0)*r*e^{r(t-t_0)}=r*P(t)$. This is important for the next model. <!-- Which is a J-shaped curve (as the $\mu(x)$ function) -->
...
::: {.column width="50%"}
-   *Linear model* (green): The population grows steadily by 10 rabbits a year. In 2100 there are 154 bunnies.
